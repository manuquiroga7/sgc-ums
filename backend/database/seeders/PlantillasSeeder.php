...
class PlantillasSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $bombero = [
            ...
            'intervalo_meses' => 12,
            'item_fields' => [
                ['key' => 'producto', 'label' => ['es' => 'Producto', 'en' => 'Product'], 'type' => 'producto_ref', 'categoria' => 'Traje de Bombero'],
                ['key' => 'fabricante', 'label' => ['es' => 'Fabricante', 'en' => 'Make'], 'type' => 'text'],
                ['key' => 'modelo', 'label' => ['es' => 'Modelo', 'en' => 'Model'], 'type' => 'text'],
                ['key' => 'numero_serie', 'label' => ['es' => 'N° de serie', 'en' => 'Serial No'], 'type' => 'text', 'required' => true],
                ['key' => 'chaqueta', 'label' => ['es' => 'Chaqueta', 'en' => 'Jacket'], 'type' => 'number'],
                ['key' => 'pantalon', 'label' => ['es' => 'Pantalón', 'en' => 'Pants'], 'type' => 'number'],
                ['key' => 'guantes', 'label' => ['es' => 'Guantes', 'en' => 'Gloves'], 'type' => 'number'],
                ['key' => 'botas', 'label' => ['es' => 'Botas', 'en' => 'Boots'], 'type' => 'number'],
                ['key' => 'casco', 'label' => ['es' => 'Casco', 'en' => 'Helmet'], 'type' => 'number'],
                ['key' => 'protector_facial', 'label' => ['es' => 'Protector facial', 'en' => 'Face shield'], 'type' => 'number'],
                ['key' => 'cuerda_vida', 'label' => ['es' => 'Cuerda de vida', 'en' => 'Rope life'], 'type' => 'number'],
                ['key' => 'cinturon', 'label' => ['es' => 'Cinturón', 'en' => 'Belt'], 'type' => 'number'],
                ['key' => 'linterna', 'label' => ['es' => 'Linterna', 'en' => 'Safety lamp'], 'type' => 'text'],
                [
                    'key' => 'resultado', 'label' => ['es' => 'Verificado', 'en' => 'Checked'], 'type' => 'select',
                    'options' => [
                        ['value' => 'OK', 'label' => ['es' => 'OK', 'en' => 'OK']],
    ...
    private function trajeInmersion(): void
    {
        ...
        $plantilla = [
            ...
            'item_fields' => [
                ['key' => 'producto', 'label' => ['es' => 'Tipo', 'en' => 'Type'], 'type' => 'producto_ref', 'categoria' => 'Traje de Inmersión'],
                ['key' => 'numero_serie', 'label' => ['es' => 'N° de serie', 'en' => 'Serial No'], 'type' => 'text', 'required' => true],
                ['key' => 'fabricante', 'label' => ['es' => 'Fabricante', 'en' => 'Make'], 'type' => 'text'],
                ['key' => 'modelo', 'label' => ['es' => 'Modelo', 'en' => 'Model'], 'type' => 'text'],
                ['key' => 'fecha_fabricacion', 'label' => ['es' => 'Fecha fab.', 'en' => 'Date of manuf.'], 'type' => 'date'],
                [
                    'key' => 'aprobacion', 'label' => ['es' => 'Aprobación', 'en' => 'Approval'], 'type' => 'select',
                    'options' => [
                        ['value' => 'SOLAS', 'label' => ['es' => 'SOLAS', 'en' => 'SOLAS']],
                        ['value' => 'MSC', 'label' => ['es' => 'MSC', 'en' => 'MSC']],
                    ],
                ],
                ['key' => 'aislado_termico', 'label' => ['es' => 'Aislado térmicamente', 'en' => 'Therm. insulated'], 'type' => 'boolean'],
                ['key' => 'autoflotante', 'label' => ['es' => 'Autoflotante', 'en' => 'Self buoyant'], 'type' => 'boolean'],
                ['key' => 'venc_luz', 'label' => ['es' => 'Venc. luz', 'en' => 'Light exp. date'], 'type' => 'date'],
            ],
            'trabajos' => [
                ['codigo' => '1', 'label' => ['es' => 'Inspección visual de todos los componentes, estado y partes adjuntas', 'en' => 'Visual inspection of all components, condition and attached parts']],
    ...
    private function cilindrosGas(): void
    {
        ...
        $plantilla = [
            ...
            'intervalo_meses' => 12,
            'item_fields' => [
                ['key' => 'producto', 'label' => ['es' => 'Tipo', 'en' => 'Type'], 'type' => 'producto_ref', 'categoria' => 'Cilindro de Gas'],
                ['key' => 'numero_serie', 'label' => ['es' => 'N° de serie', 'en' => 'Serial No'], 'type' => 'text', 'required' => true],
                ['key' => 'presion_servicio', 'label' => ['es' => 'Presión de servicio', 'en' => 'Pressure service'], 'type' => 'text'],
                ['key' => 'volumen', 'label' => ['es' => 'Volumen (litros)', 'en' => 'Volume (litres)'], 'type' => 'number'],
                ['key' => 'ultima_prueba_hidraulica', 'label' => ['es' => 'Última prueba hidráulica', 'en' => 'Last hydrotest'], 'type' => 'text'],
            ],
            'trabajos' => [
    ...
    private function chalecosAros(): void
    {
        ...
        $plantilla = [
            ...
            'intervalo_meses' => 12,
            'item_fields' => [
                ['key' => 'producto', 'label' => ['es' => 'Tipo', 'en' => 'Type'], 'type' => 'producto_ref', 'categoria' => $cat],
                ['key' => 'fabricante', 'label' => ['es' => 'Fabricante', 'en' => 'Make'], 'type' => 'text'],
                ['key' => 'modelo', 'label' => ['es' => 'Modelo', 'en' => 'Model'], 'type' => 'text'],
                ['key' => 'numero_serie', 'label' => ['es' => 'N° de serie', 'en' => 'Serial No'], 'type' => 'text', 'required' => true],
                ['key' => 'venc_luz', 'label' => ['es' => 'Venc. luz', 'en' => 'Light exp. date'], 'type' => 'date'],
                ['key' => 'aprobacion', 'label' => ['es' => 'Aprobación', 'en' => 'Approval'], 'type' => 'text'],
            ],
            'trabajos' => [
                ['codigo' => '1', 'label' => ['es' => 'Inspección visual de todos los componentes, estado y partes adjuntas', 'en' => 'Visual inspection of all components, condition and attached parts']],
    ...
    private function equipoRespiracion(): void
    {
        ...
        $plantilla = [
            ...
            'item_fields' => [
                ...
                ['key' => 'modelo', 'label' => ['es' => 'Modelo', 'en' => 'Model'], 'type' => 'text'],
                ['key' => 'numero_serie', 'label' => ['es' => 'N° de serie', 'en' => 'Serial No'], 'type' => 'text', 'required' => true],
                ['key' => 'remarks', 'label' => ['es' => 'Observaciones', 'en' => 'Remarks'], 'type' => 'text'],
            ],
            'trabajos' => [
                ['codigo' => '1', 'label' => ['es' => 'Controlado a bordo', 'en' => 'Checked on board']],
                ['codigo' => '2', 'label' => ['es' => 'Inspeccionado en taller', 'en' => 'Inspected in workshop']],
